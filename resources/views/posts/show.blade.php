        ...
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <div class="about-author d-flex p-4 bg-light">
                    <div class="bio mr-5">
                        <img src="{{ $user->hasPicture() ? asset('storage/'.$user->getPicture()) : $user->getGravatar() }}" alt="Image placeholder" style="border-radius: 50%;width: 150px;height: 200px;" class="img-fluid mb-4">
                    </div>
                    <div class="desc">
                        <h3>{{ $user->name }}</h3>
                        <p>{{ $profile->about }}</p>
